...
const render = createRenderer({
  ...
  onReorder(id, targetId, position) {
    store.dispatch({ type: "MOVE_STREAM", id, targetId, position });
  },
});
...
layoutToggle.addEventListener("click", () => store.dispatch({ type: "TOGGLE_LAYOUT" }));
audioToggle.addEventListener("click", () => store.dispatch({ type: "TOGGLE_AUDIO_FOCUS" }));
